...
```bash
git clone git@github.com:optimistic-data-spirit/clouds.git
```
...
### Download the data
Download the [data](https://www.kaggle.com/c/understanding_cloud_organization/data) and save locally in you `data/raw` folder without changing the file name.
